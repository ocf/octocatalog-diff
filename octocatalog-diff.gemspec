...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<puppet>, ["~> 5.4.0"])
      ...
      s.add_development_dependency(%q<simplecov-erb>, ["~> 0.1.1"])
    else
      ...
      s.add_dependency(%q<puppet>, ["~> 5.4.0"])
      ...
      s.add_dependency(%q<simplecov-erb>, ["~> 0.1.1"])
    end
  else
    s.add_dependency(%q<diffy>, [">= 3.1.0"])
    s.add_dependency(%q<hashdiff>, [">= 0.3.0"])
